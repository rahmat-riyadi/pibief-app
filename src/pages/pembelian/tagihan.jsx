	...
	return(
		<Box 
			sx={{ 
				width: 'fit-content', 
				p: '6px 8px', 
				bgcolor: status === 'Lunas' ? 'rgba(80, 205, 137, 0.2)' : 'rgba(249, 161, 27, 0.2)',
...
const Tagihan = () => {
  ...
  return (
    <Box>
    <BreadCrumbsNav/>
    <Typography variant='h5' sx={{ my: '20px', fontSize: 21, fontWeight: 600 }} >
        Tagihan
    </Typography>
    <Typography variant='body1' sx={{ fontWeight: '300', fontSize: 12, mb: 2 }} >
                    ...
                    <TableRow hover >
                        ...
                        <TableCell padding ='none' sx={{ pr: 2 }}  >
                            <Stack direction='row' justifyContent='space-between' >
                                <Button color='greyFont' variant='outlined' size='small' style={{ p: '8px', textTransform: 'capitalize', fontSize: '12px' }} onClick={ () => navigate('/pembelian/tagihan/detail/:id') }  >
                                    Lihat
                                </Button>
                                <Button color='greyFont' variant='outlined' size='small' style={{ p: '8px', textTransform: 'capitalize', fontSize: '12px'  }}  >
                                    Hapus
                                </Button>
                            </Stack>
                        </TableCell>
